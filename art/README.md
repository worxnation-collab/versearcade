...
| `cooldad.json` | the "Cool Dad" skin — the app's owner as a character, from likeness photos not kept in the repo (see the manifest's `note`) | `public/skins/cooldad.png` |
