...
export const FULL_SKINS: SkinDef[] = [
  ...
  },
  {
    ...
    // collar, a coffee and a kid-size football under the other arm. The same
    ...
    exclusive: true,
    packName: 'Cool Dad',
    blurb: 'Coffee in one hand, the little one\u2019s football under the other arm. Redeem the code to wear it.',
  },
]
