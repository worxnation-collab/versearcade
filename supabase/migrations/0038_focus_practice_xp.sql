...
-- Sits alongside "study the last five" rather than replacing it: that replays
-- verses you've already played, this drills a book you choose.
--
-- NOTE: this SQL is already live. It shipped in PR #57 as 0036_focus_practice_xp
-- and was applied then, but the file was lost when PR #58 landed from a stale
-- branch. Re-added here under a free number so the repo matches the database;
